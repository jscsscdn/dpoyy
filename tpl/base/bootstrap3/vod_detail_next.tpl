...
<div class="btn-group">
<a id="ff-prev" href="{:ff_url_read_vod($item_prev['list_id'],$item_prev['list_dir'],$item_prev['vod_id'],$item_prev['vod_ename'],$item_prev['vod_jumpurl'])}" class="btn btn-default btn-sm hidden-xs－ <empty name="item_prev">disabled</empty>"><span class="glyphicon glyphicon-chevron-left text-green ml-2 mr-1"></span></a>
